...
################################################
	...
	function compare_date ($other) {
		...
		$my_day = $this->get ("day", 32); $my_month = $this->get ("month", 13); $my_year = $this->get ("year");
		$other_day = $other->get ("day", 32); $other_month = $other->get ("month", 13); $other_year = $other->get ("year");
